...
<head>
    ...
    <style>
        ...
        .btn-secondary {
            background-color: #777; /* Warna tombol reset (abu-abu) */
            border: none;
        }
        ...
        .invalid-feedback {
            color: #FF0000; /* Warna pesan kesalahan (merah) */
        }
    </style>
</head>
...
<body>
    <div class="wrapper">
        <h2>Registrasi</h2>
        <p>Tolong isi data di bawah untuk membuat akun.</p>
